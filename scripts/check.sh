...
run_check 'Private baseline evidence behavior' \
...
run_check 'Snapshot recovery provider behavior' \
    "$REPO_ROOT/tests/test-maintenance-snapshot.sh"
run_check 'Incoming Git candidate behavior' \
...
run_check 'OCR clipboard behavior' "$REPO_ROOT/tests/test-text-extractor.sh"
run_check 'Wallpaper automation lifecycle' \
    "$REPO_ROOT/tests/test-wallpaper-automation.sh"
run_check 'Quickshell application lifecycle' \
    "$REPO_ROOT/tests/test-quickshell-launchers.sh"
...
run_check 'Desktop application launchers' \
    "$REPO_ROOT/tests/test-application-launchers.sh"
run_check 'GTK theme listener resilience' "$REPO_ROOT/tests/test-theme-listener.sh"
