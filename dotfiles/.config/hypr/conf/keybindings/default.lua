...
hl.bind("SUPER + F11", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/toggle-refresh.sh low"), { description = "Use low display refresh rate" })
hl.bind("SUPER + F12", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/toggle-refresh.sh high"), { description = "Use high display refresh rate" })
-- Updated bind without the forced fullscreen flag
hl.bind("Print", hl.dsp.exec_cmd("hyprshot -m region --raw | satty --filename -"), { description = "Capture a screen region" })
-- Windows
...
hl.bind(mainMod .. " + SHIFT + H", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/hyprshade.sh"), { description = "Select a screen shader" })
hl.bind("CTRL + Tab", hl.dsp.exec_cmd("~/.config/myhypr/scripts/focus.sh"), { description = "Open Select Window Menu" })
hl.bind("CTRL + ALT + T", hl.dsp.exec_cmd("~/.config/myhypr/themes/themes.sh"), { description = "Open theme selector" })
...
hl.bind(mainMod .. " + CTRL + 1", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/moveTo.sh 1"), { description = "Move all windows to workspace 1" })
hl.bind(mainMod .. " + CTRL + 2", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/moveTo.sh 2"), { description = "Move all windows to workspace 2" })
hl.bind(mainMod .. " + CTRL + 3", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/moveTo.sh 3"), { description = "Move all windows to workspace 3" })
hl.bind(mainMod .. " + CTRL + 4", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/moveTo.sh 4"), { description = "Move all windows to workspace 4" })
hl.bind(mainMod .. " + CTRL + 5", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/moveTo.sh 5"), { description = "Move all windows to workspace 5" })
hl.bind(mainMod .. " + CTRL + 6", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/moveTo.sh 6"), { description = "Move all windows to workspace 6" })
hl.bind(mainMod .. " + CTRL + 7", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/moveTo.sh 7"), { description = "Move all windows to workspace 7" })
hl.bind(mainMod .. " + CTRL + 8", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/moveTo.sh 8"), { description = "Move all windows to workspace 8" })
hl.bind(mainMod .. " + CTRL + 9", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/moveTo.sh 9"), { description = "Move all windows to workspace 9" })
hl.bind(mainMod .. " + CTRL + 0", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/moveTo.sh 10"), { description = "Move all windows to workspace 10" })
...
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+"), { description = "Increase volume by 5%", locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-"), { description = "Reduce volume by 5%", locked = true, repeating = true })
