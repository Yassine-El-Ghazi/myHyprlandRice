...
6. Stage intentionally, inspect `git diff --cached`, then run `./scripts/audit.sh --staged`.
7. Use a focused Conventional Commit message such as `fix(hypr): select focused output dynamically`.
